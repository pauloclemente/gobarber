...
export const Title = styled.Text`
  ...
  margin: 0 24px 24px;
`
export const OpenDatePickerBtn = styled(RectButton)`
  height: 46px;
  background: #ff9000;
  border-radius: 10px;
  align-items: center;
  ...
  margin: 0 24px;
`
export const OpenDatePickerBtnTxt = styled.Text`
  font-family: 'RobotoSlab-Medium';
  font-size: 16px;
  color: #232129;
`
...
`
export const HourTxt = styled.Text<IHourTxt>`
  color: ${props => (props.selected ? '#232129' : '#f4ede8')};
  font-family: 'RobotoSlab-Regular';
  font-size: 16px;
`
export const CreateAppointmentBtn = styled(RectButton)`
  height: 50px;
  background: #ff9000;
  border-radius: 10px;
  align-items: center;
  ...
  margin: 0 24px 24px;
`
export const CreateAppointmentBtnTxt = styled.Text`
  font-family: 'RobotoSlab-Medium';
  font-size: 18px;
  color: #232129;
`
